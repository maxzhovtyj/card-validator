...
type CardServiceClient interface {
	Validate(ctx context.Context, in *ValidateCardRequest, opts ...grpc.CallOption) (*ValidateCardResponse, error)
}
...
func (c *cardServiceClient) Validate(ctx context.Context, in *ValidateCardRequest, opts ...grpc.CallOption) (*ValidateCardResponse, error) {
	out := new(ValidateCardResponse)
	err := c.cc.Invoke(ctx, "/CardService/Validate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CardServiceServer interface {
	Validate(context.Context, *ValidateCardRequest) (*ValidateCardResponse, error)
...
func (UnimplementedCardServiceServer) Validate(context.Context, *ValidateCardRequest) (*ValidateCardResponse, error) {
...
func _CardService_Validate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateCardRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CardServiceServer).Validate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/CardService/Validate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CardServiceServer).Validate(ctx, req.(*ValidateCardRequest))
	}
...
var CardService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Validate",
			Handler:    _CardService_Validate_Handler,
		},
	},
